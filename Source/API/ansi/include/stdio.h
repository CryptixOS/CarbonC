...
int vasprintf(char** strp, char const* fmt, va_list)
    __attribute__((format(printf, 2, 0)));
int vsprintf(char* buffer, char const* fmt, va_list)
    __attribute__((format(printf, 2, 0)));
int vsnprintf(char* buffer, size_t, char const* fmt, va_list)
    __attribute__((format(printf, 3, 0)));
int vdprintf(int, char const* fmt, va_list)
    __attribute__((format(printf, 2, 0)));
...
int asprintf(char** strp, char const* fmt, ...)
    __attribute__((format(printf, 2, 3)));
int snprintf(char* buffer, size_t, char const* fmt, ...)
...
int   renameat(int olddirfd, char const* oldpath, int newdirfd,
               char const* newpath);
FILE* tmpfile(void);
char* tmpnam(char*);
