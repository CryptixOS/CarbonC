...
extern "C"
{
    ...
    void* memset(void* dest, i32 ch, usize len) throw()
    {
        u8* d = static_cast<u8*>(dest);
    ...
    i32 memcmp(const void* ptr1, const void* ptr2, usize len) throw()
    {
    ...
    void* memchr(const void* ptr, i32 ch, usize len)
    {
    ...
    i32 strcmp(const char* str1, const char* str2) throw()
    {
    ...
    i32 strncmp(const char* str1, const char* str2, usize len) throw()
    {
